...
date: "2024/01/07 (updated: `r Sys.Date()`)"
output:
...
##### 08.01.2025 | Prof. Dr. Caroline Zygar-Hoffmann
...
* Ökonomie im Kontext der Versuchsplanung: notwendiger Aufwand (möglichst gering zu halten)

**Leitfrage:** Wie muss ich eine Untersuchung gestalten, damit sie mir neue Erkenntnisse über die Gültigkeit meiner Hypothese liefern kann?
...
* können einen tatsächlich vorhandenen Effekt verschleiern:
  * **Beispiel**: überwiegend unmotivierte Versuchspersonen in der Trainingsbedingung: positiver Effekt des Trainings (UV) wird durch negativen Effekt der Motivation (SV) verdeckt
...
Treffen die folgenden Aussagen im Kontext des obigen Beispiels zu?
...
* erklären unter anderem warum nicht alle Personen denselben Wert auf der AV haben $\rightarrow$ gibt es in jeder Untersuchung; vergrößern die Varianz in der AV (Fehlervarianz; „Rauschen“; geringe Reliabilität der Messung; "zufällige Störvariablen")
...
* die gemeinsame systematische Variation von möglichen Störfaktoren mit der hypothesenrelevanten UV (= "Konfundierung") zu verhindern 
* anders ausgedrückt: die statistische Assoziation zwischen den potentiellen Störfaktoren und der UV auf den Wert Null zu bringen
...
* Einbeziehen der Störvariable in das Untersuchungsdesign als Kontrollfaktor (d.h. wird miterhoben und/oder zusätzlich systematisch varriert)
...
* keine zufällige Zuordnun g$\rightarrow$  Vortest notwendig zur Korrektur der Vorher‐Unterschiede
...
* Beispiele: 
  * Sind Probanden eher bereit, noch einen zweiten FB auszufüllen, wenn man ihnen zuvor fröhliche Musik vorgespielt hat?
...
* Beispiele: 
  ...
  * Spielverhalten von Kindern am Spielplatz mit & ohne Anwesenheit der Eltern
]
...
* **Interne Validität** 
  ...
  * erreicht, wenn alle relevanten systematischen Störvariablen ausgeschlossen
...
* Experimenteller vs. Assoziativer/korrelativer Ansatz vs. Quasi-experimenteller Ansatz
...
**[zurück zur heutigen Übersicht der Vorlesung $\rightarrow$](#content)** **[zum Quiz zur Wissensprüfung $\rightarrow$](https://forms.gle/TueFEhG8YGK7n92bA)**
