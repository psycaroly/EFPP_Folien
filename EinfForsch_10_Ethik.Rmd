...
##### 26.01.2024 | Dr. Caroline Zygar-Hoffmann
...
* Wissenschaftliches Vorgehen darstellen, begründen und zu Kritik zugänglich zu machen $\rightarrow$ z.B. durch peer-review
...
<br>
**[zum Quiz zur Wissensprüfung $\rightarrow$](https://forms.gle/x3vA7Uf2KxC3AcEL9)**

---
class: top, left

### Nächste Woche: Zusammenfassung + Fragestunde
...
<!-- library(renderthis)  -->
<!-- to_pdf("EinfForsch_10_Ethik.Rmd", complex_slides = TRUE) -->
