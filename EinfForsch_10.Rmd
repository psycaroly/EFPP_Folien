...
Klinische Psychologie hat enge Beziehungen zu  anderen Wissenschaftsdisziplinen
* Psychiatrie
* Soziologie
* neurobiologische Fächer (einschließlich der Gebiete Genetik und Psychopharmakologie)
* Neurologie und andere medizinische Fächer.
...
* Stattdessen: nützliche Konstrukte, auf die sich Forscher:innen und Praktiker:innen als bestmögliche Lösung für eine begrenzte Zeit geeinigt haben
...
* Kliniker:innen und Forscher:innen erwarten oft, dass eine Behandlung das Problem, das der Klient:innen in die Therapie mitbringen, beseitigt. 

* Eine Möglichkeit, diesen Prozess zu konzeptualisieren, besteht darin, die Klient:innen, die eine Therapie beginnen, als Teil einer dysfunktionalen Population zu betrachten. 
...
* Um für c zu lösen, werden Daten aus einer normativen Stichprobe für die interessierende Variable benötigt.
...
* Eines der am häufigsten verwendeten Instrumente zur Bewertung von Depressionen bei Erwachsenen 

* Ermöglicht es Kliniker:innen, die Art und den Schweregrad von Stimmungsstörungen bei Patientenpopulationen zu beurteilen. 
...
* HDRS wird in klinischen Studien oft zur Evaluation der antidepressiven Wirksamkeit von Therapien genutzt.
...
* HDRS Score soll herunter gehen $\rightarrow$ SSRI schneidet zum Endpunkt (Woche 10) am besten ab, Placebo am schlechtesten
...
* Es können Marker in der Aktivität von Proband:innen bestimmt werden.
...
* Gekennzeichnet z.B. durch Antriebslosigkeit, sozialen Rückzug, Rumination
...
* **Psychische Störungen** sind Konstrukte, auf die sich Forscher:innen und Praktiker:innen als bestmögliche Lösung für eine begrenzte Zeit geeinigt haben (können sich ändern).
...
* Neuere Auffassungen mentaler Gesundheit beinhalten dass psychische Störungen als **komplexe Systeme** von Einzelphänomenen operationalisiert werden sollten.
]
