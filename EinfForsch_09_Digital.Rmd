...
##### 22.01.2024 | Prof. Dr. Caroline Zygar-Hoffmann
...
* ggf. Verringerung des Reaktivitätsproblems
]
]
...
* Der Begriff "Ambulatory Assessment" (Ebner-Priemer & Trull, 2009) umfasst eine Reihe methodischer Ansätze
  - "Experience Sampling Method" (ESM, Larson & Csikszentmihalyi, 1983), auch "Ecological Momentary Assessment" (EMA, Shiffmann et al., 2008) $\rightarrow$ mehrmals tägliche Erfassung (meist Selbst-/Fremdauskunft)
  - "Daily Diaries" (Gunthert & Wenze, 2012) $\rightarrow$ tägliche Abendbefragung ("Tagebuch", meist Selbst-/Fremdauskunft)
  - "Mobile Sensing" $\rightarrow$ Erhebung der Smartphone/Wearable Nutzungs- und Sensordaten
  - "Ambient Sensing" $\rightarrow$ Erhebung von in der Umgebung eingebauter Sensordaten
...
---
class: top, left
<div class="footer"><span>Bergelson, E., Soderstrom, M., Schwarz, I. C., Rowland, C. F., Ramírez-Esparza, N., R. Hamrick, L., ... & Cristia, A. (2023). Everyday language input and production in 1,001 children from six continents. Proceedings of the National Academy of Sciences, 120(52), e2300671120.</span></div>

### Ambulatory Assessment & Ecological Momentary Interventions

#### Mobile Sensing Studie im e ntwicklungspsychologischen Bereich

```{r eval = TRUE, echo = F, out.width = "55%"}
knitr::include_graphics("bilder/Bergelson.png")
```
...
* **Fixed scheme:** Teilnehmer werden zu festen Zeitpunkten aufgefordert, z. B. um 9:30 und 16:30 Uhr $\rightarrow$ für die Versuchspersonen vorhersehbar, höhere Antwortquote, aber auch höhere **Reaktivität** durch Verhaltensanpassung kurz vor erwarteter Befragung
...
---
class: top, left
<div class="footer"><span>Hall, M., Lappenbusch, L. M., Wiegmann, E., & Rubel, J. A. (2024). To Use or Not to Use: Exploring Therapists’ Experiences with Pre-Treatment EMA-Based Personalized Feedback in the TheraNet Project. Administration and Policy in Mental Health and Mental Health Services Research, 1-18.</span></div>

### Ambulatory Assessment & Ecological Momentary Interventions

#### ESM/EMA: Erfahrungen zu Anwendung im klinischen Kontext

```{r eval = TRUE, echo = F, out.width = "55%"}
knitr::include_graphics("bilder/hall.png")
```

---
class: top, left
<div class="footer"><span>Heron, K. E., & Smyth, J. M. (2010). Ecological momentary interventions: incorporating mobile technology into psychosocial and health behaviour treatments. British journal of health psychology, 15(1), 1-39.</span></div>
...
* Und in der Psychologie? **Besonders für das Ziel der Vorhersage sehr relevant!** (für das Ziel der Erklärung weniger, da die Modelle selbst oft eine "Black Box" sind) $\rightarrow$ vielversprechende Forschung
...
knitr::include_graphics("bilder/class_regre.png")
```
]
...
<br>
**[zum Quiz zur Wissensprüfung $\rightarrow$](https://forms.gle/3X8y12D7Gsb9nq2e7)**

---
class: top, left

### Sitzung am 05.02.2025: Zusammenfassung + Fragestunde
