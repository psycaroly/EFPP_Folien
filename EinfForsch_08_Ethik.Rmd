...
date: "2024/01/14 (updated: `r Sys.Date()`)"
output:
...
##### 15.01.2025 | Prof. Dr. Caroline Zygar-Hoffmann
...
* Forschungsethik: die geteilten Werte und Normen eines Fachs, die das Handeln von Forschenden leiten. Außerdem alle
Maßnahmen zur Prüfung und Sicherstellung der Einhaltung dieser Normen.
...
* **Open Data** (offene Forschungsdaten, soweit unter Wahrung des Datenschutzes möglich) zur Prüfung der Reproduzierbarkeit, Finden von Fehlern, Nachnutzbarkeit
...
Wichtig: Außerdem **Präregistrierung:** Planung der Studie (u.a. Hypothesen, Messinstrument, Analyse) vor der Datenerhebung öffentlich einsehbar festhalten
...
* **Open Science** ist Teil guter wissenschaftlicher Praxis, eine Lösung für aktuelle Probleme in der Psychologie und umfasst mehrere Teilbereich, wie z.B. **Open Data**, **Open Materials** und **Präregistrierung**
]
...
<br>
**[zum Quiz zur Wissensprüfung $\rightarrow$](https://forms.gle/aF8L9EdX7T5ienPD6)**
