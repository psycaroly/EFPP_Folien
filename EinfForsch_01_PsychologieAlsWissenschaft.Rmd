...
date: "2025/04/09 (updated: `r Sys.Date()`)"
output:
...
##### 10.04.2025 | Prof. Dr. Caroline Zygar-Hoffmann
...
* Mutter eines fast 3-jährigen Sohns
...
.center[
**Wer von Ihnen hat schonmal studiert?**
]
...
.center[
**Wer von Ihnen hat schonmal an einer psychologischen Studie teilgenommen?**
]
...
**12 Termine:** Donnerstag 11:35 - 13:05 (Raum: Audimax)
...
**Materialien:**
* Folien werden auf [studynet](https://studynet.hs-fresenius.de/ilias.php?baseClass=ilrepositorygui&ref_id=39930) bereitgestellt in 2 Varianten: html (Links zwischen Folien funktionieren) und PDF (Platz für Notizen)
* Vielen Dank an Prof. Dr. Stephan Goerigk für Bereitstellung der Grundlage für die Materialien

**Prüfungsleistung:**
* Zeitraum für die Prüfungsanmeldung: 23.06.25 - 14.07.25
...
* Nachbesprechungen der Literatur-Such-Aufgaben
...
* ...definieren
* ...quantifizieren
* ...deskriptiv als zusammenhängend beschreiben (hier ist die Trennung zum Ziel der Vorhersage unscharf)
...
* Erklärungen gehen über das Beschreibende hinaus
...
* Geben Sie Ihre Ergebnisse im [studynet im Ordner "Einheit 1"](https://studynet.hs-fresenius.de/ilias.php?baseClass=ilrepositorygui&ref_id=40734) unter "Literatursuch-Aufgabe" ab.
...
<br>
**[zum Quiz zur Wissensprüfung $\rightarrow$](https://forms.gle/SxBrfVLj2j4sZg6o6)**
