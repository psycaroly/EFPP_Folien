...
##### 31.05.2023 | Prof. Dr. phil. Stephan Goerigk
...
* Moderationsmethode (Klebert et al. 1984)
  * Moderierter Gruppenprozess unter Verwendung diverser Methoden (multimethodal)
...
* Untersuchung von Abschiedsbriefen vor Suizid (Jacobs 1967). 
  ...
  $\rightarrow$ Bestimmte Regelmäßigkeiten (z.B. die Bitte um Verzeihung) konnten gefunden werden.
...
#### Beispiel Archivstrategien: Abschiedsbriefe vor Suizid (Jacobs 1967)

.pull-left[
* Untersuchung von 112 Abschiedsbriefen
...
Historiographie:
* Methode zur Entschlüsselung historiographischer und biographischer, vergangener Ereignisse auf Basis von Quellen

* Untersuchung und Erklärung von Zusasammenhängen und deren wirkungsgeschichtlichen Bedeutung (kein reines Aneinanderreihen von Fakten)
...
### Take-Aways
.content-box-gray[
* Menschliches Verhalten und Empfinden ist **nicht nur „rational“** $\rightarrow$ Methodenset zum Verstehen subjektiven Verhaltens und Erlebens wird benötigt
...
* Standardisierte **Transkription** ermöglicht die spätere Analyse von Beohachtungs- und Interviewsituationen.
