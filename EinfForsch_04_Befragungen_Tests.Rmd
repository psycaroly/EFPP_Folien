...
date: "2024/11/08 (updated: `r Sys.Date()`)"
output:
...
##### 13.11.2024 | Dr. Caroline Zygar-Hoffmann
...
* Es wird zwischen **subjektiven** und **objektiven **Persönlichkeitstests unterschieden, je nachdem ob sie auf Selbst- oder Fremdauskunft auf Fragebogenitems basieren ( $\rightarrow$ subjektiv) oder nicht ( $\rightarrow$ objektiv)
  * Bei subjektiven Persönlichkeitstests ist der Zweck des Tests für die getesteten Personen leicht durchschaubar
  * Bei objektiven Persönlichkeitstests wird versucht, den Zweck zu verschleiern, um so die Reaktivität der Datenerhebung zu minimieren und die Validität der Ergebnisse zu erhöhen $\rightarrow$ es ist nicht erforderlich, dass die Personen eine explizite Repräsentation von dem zu messenden Konstrukt haben
...
* Beantworten Sie die folgenden Fragen (dafür müssen Sie in den Artikel reinschauen, der Abstract wird i.d.R. nicht reichen):
  ...
  - Gibt es numerische, verbale oder grafische Marker?
...
* Geben Sie Ihre Ergebnisse im [studynet im Ordner "Einheit 4"](https://studynet.hs-fresenius.de/goto_STUDYNETHSF_exc_35034.html) unter "Literatursuch-Aufgabe" ab.
...
<br>
**[zum Quiz zur Wissensprüfung $\rightarrow$](https://forms.gle/pmpMjiXLh4aMUciV6)**
---
class: top, left
