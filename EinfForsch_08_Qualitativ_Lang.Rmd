...
.center["Höchste Vollkommenheit in der Auslegung ist nach Schleiermacher dann erreicht, wenn durch die Interpretation der Autor bzw. die Autorin besser verstanden wird, als er/sie von sich selbst Rechenschaft geben könne (Jung 2001, S. 64)." 
...
* **Validität:** 
  ...
  - Angemessenheit der Darstellung in Beobachtungsprotokollen
...
<br>
**[zum Quiz zur Wissensprüfung $\rightarrow$](https://forms.gle/ADUnr1eCY82hiLPD7)**
...
<!-- library(renderthis)  -->
<!-- to_pdf("EinfForsch_05_Qualitativ.Rmd", complex_slides = TRUE) -->
