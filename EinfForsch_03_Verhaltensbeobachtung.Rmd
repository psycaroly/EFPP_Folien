...
.pull-left[
**Kategoriesystem:** Gliederung des beobachtbaren Verhaltens in Kategorien als Indikatoren $\rightarrow$ Kritik an Vollständigkeit, Eindeutigkeit und Überschendigungsfreiheit der Kategorien
...
Beispiel: nominales Urteil (ja/nein), Beobachterübereinstimmung z.B. über Cohen's Kappa oder Fleiss' Kappa berechenbar
...
Beispiel: metrisches Urteil (Skala 1-6), Beobachterübereinstimmung z.B. über Intra-Class-Korrelationen (ICC) berechenbar
...
* Geben Sie Ihre Ergebnisse im [studynet im Ordner "Einheit 3"](https://studynet.hs-fresenius.de/goto_STUDYNETHSF_exc_34598.html) unter "Literatursuch-Aufgabe" ab.
...
<br>
**[zum Quiz zur Wissensprüfung $\rightarrow$](https://forms.gle/MddF4mC5CphEvGfW7)**
